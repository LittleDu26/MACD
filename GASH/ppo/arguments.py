...
def get_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help='resume GA from this generation without interactive input')
    parser.add_argument(
        '--budget-termination',
        type=int,
        default=0,
        help='stop GA by MAX_EVALUATIONS * TRAIN_ITERS cumulative PPO iterations')
    parser.add_argument(
        '--ga-num-cores',
        type=int,
        default=None,
        help='number of GA robot-training workers')
